module.exports = {
    ...
    NY: {
        ...
        status: 'Preparing to file bill',
        riser: 'Abby Haglage',
        riser2: 'Amanda Wingle',
        url: 'https://actonthis.org/causes/rise-new-york',
        riserImages: ['./img/25.jpg','./img/15.png'],
